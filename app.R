                  ...
                  tabItems(tabItem(tabName = "motivation",
                                   ...
                                   fluidRow(column(width = 6,
                                            ...
                                            column(width = 6,
                                                   ...
                                                   br(),
                                                   h5("I'm really looking forward to conducting my first large text analysis project on my favorite show. After watching the whole series almost 3 times I'm quite familiar with all the characters, lines, stories, word usages, etc.... I'm interested to see if data analysis can back up what I already know of the show, i.e.: there are clearly more negative (Angela) and positive (Jim) people in the show. There are some words and expressions that clearly 'belong' to a given character (such as beet farming to Dwight). Let's start by laying out my plan."))),
                                   fluidRow(column(width = 4,
                                                   h3("What I'll look at"),
                                                   br(),
                                                   tags$ol(tags$li('Top words and bigrams used by each character'),
                                                           tags$li('Unique-to-person words (tf-idf analysis)'),
                           ...
                           tabItem(tabName = "explore",
                                   fluidRow(div(h2("Before jumping into NLP, let's spend some time on exploring the dataset"), align = 'center'),
                                            column(width = 6,
                                                   br(),
                           ...
                           tabItem(tabName = "tokens",
                                   ...
                                   fluidRow(h3('Unnesting lines and removing stop words show that mostly used words are names of other characters'),
                                            ...
                                            h5("When talking to one another, people usually call the other by their name to get their attention. This is what seems to be the case here. For example, Dwight sits across Jim so the conversation there is logical, however he also talks often to Michael, hence the top 2 words for Dwight are Michael and Jim. It's also apparent that people use their own names as well. That's because they're mostly salesmen who need to introduce themselves over the phone. (i.e.: Dwight saying: Dwight Schrute here, heard you're running low on your paper supplies.)"),
                                            br()),
                           ...
                           tabItem(tabName = "tfidf",
                                   ...
                                   div(h6('(Give the page 5 sec to load)'), align = 'center'),
                                   h5("Running the TF-IDF on my dataset truly outlines the unique-to-given-person words. By adjusting a word's document-specific (person-specific) frequency with its total frequency throughout all documents (names), most personal words that belong to their (one and only) user can be found."),
                                   br(),
                           ...
                           tabItem(tabName = "bigrams",
                                   ...
                                   div(h6('(Give the page 5 sec to load)'), align = 'center'),
                                   h5("Bigram (pairs of words) analysis' output puts a smile on any Office fan's face: Andy's famous nickname and A capella group buddy, Dwight's farm's name, the company all of them work for, these expressions all come up when running analysis of pairs of words."),
                                   br(),
                           ...
                           tabItem(tabName = "posneg",
                                   fluidRow(div(h2("Looking at simple sentiment analysis results"), align = 'center'),
                                            ...
                                            column(width = 6,
                                                   ...
                                                   br()),
                                            br(),
                                            h5("The two approaches give similar results. Interesting to see how using a sentiment scale like AFINN and multiplying word counts with their respective scores outlines the words that contribute the most positivity or negativity to a certain character's vocabulary. The AFINN approach highlights something interesting: Pam contributes most positivity into her words, while Angela, Dwight and Darryl seem to have a more negative vibe based on their choice of words. Angela's most negative words contributes more to her vocabulary than her most positive word..."))
                                    ),
                           ...
                           tabItem(tabName = "between_sent",
                                   ...
                                   h5("Jim is nice to everyone, Erin, Michael, Pam & Phyllis seem very nice as well. Angela, Darryl, Dwight and Oscar are all mean to around half of the other guys. Angela is nicest to Dwight, which is no surprise (wink wink), while Dwight is meanest to Jim, which underlines thier 9 season long rivalry."),
                                   br(),
                           ...
                           tabItem(tabName = "jd",
                                   fluidRow(div(h2("Jim and Dwight DO end their relationship on a higher note"), align = 'center'),
                                            ...
                                            br(),
                                            h5("The simple trend analysis of by-person sentiments did not yield insights, but checking sentiments when talking to one another did succeed to outline relationships. One of my hypotheses was that Jim and Dwight ended the series being more positive to each other. Focusing on only these two and using their lines only DID come up with a better looking trendline. The volatility was somewhat irritating, so I double checked by using a different sentiment analysis approach, and the similar results made me more confident."),
                                            br(),
                                            column(width = 6,
                           ...
                           tabItem(tabName = "lda",
                                   ...
                                   br(),
                                   h5("As mentioned, I did not see anything special in LDA for topic extraction by characters, but feel free to look at the results yourself."),
                                   br(),
